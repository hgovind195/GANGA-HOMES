          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute top-2.5 right-3 w-2 h-2 border-t-2 border-r-2 border-[#725B24]/30 pointer-events-none group-hover:border-[#725B24] transition-colors"></div>
                <div className="absolute bottom-2.5 left-3 w-2 h-2 border-b-2 border-l-2 border-[#725B24]/30 pointer-events-none group-hover:border-[#725B24] transition-colors"></div>
                <div className="absolute bottom-2.5 right-3 w-2 h-2 border-b-2 border-r-2 border-[#725B24]/30 pointer-events-none group-hover:border-[#725B24] transition-colors"></div>
                ...
                <div className="lg:col-span-5 flex flex-col gap-4">
                  ...
                  <div className="flex items-center justify-between pb-1 border-b border-[#F0EDE9]">
                    <div className="flex items-center gap-2">
                      <div className="w-10 h-10 rounded-xl bg-[#F0EDE9] flex items-center justify-center text-[#725B24] group-hover:bg-[#725B24] group-hover:text-white transition-all duration-300 shadow-xs">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="font-label-sm text-[9px] uppercase tracking-widest text-neutral-400">
                          Discipline Standard
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#FCF9F4] border border-[#E8DFCE] font-mono text-[10px] text-[#725B24] font-semibold">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#725B24] group-hover:bg-[#0f2347] transition-colors"></span>
                      <span>{service.specCode}</span>
                    </div>
                  </div>

                  <h2 className="font-headline-lg text-2xl sm:text-3xl text-[#1C1C19] font-bold group-hover:text-[#0f2347] transition-colors">
                    {service.title}
                  </h2>
                  ...
                  <p className="font-body-md text-sm text-[#404945] leading-relaxed">
                    {service.description}
                  </p>
                </div>

                {/* Right Column: Key Deliverables Box with Micro Element Styling */}
                <div className="lg:col-span-7 bg-[#FBF9F5] p-6 sm:p-7 rounded-xl border border-[#E8DFCE] flex flex-col gap-4 relative group-hover:border-[#725B24]/40 transition-colors">
                  {/* Small Header Element with Decorative Dot-bar */}
                  <div className="flex items-center justify-between pb-2 border-b border-[#E8DFCE]">
                    <span className="font-label-sm text-xs uppercase tracking-wider text-[#1C1C19] font-bold flex items-center gap-2">
                      <Layers className="w-4 h-4 text-[#725B24]" />
                      <span>Key Deliverables &amp; Specifications</span>
                    </span>
                    <span className="font-mono text-[10px] uppercase tracking-widest text-[#725B24] bg-[#725B24]/10 px-2 py-0.5 rounded-md font-semibold">
                      Quality Verified
                    </span>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                    {service.features.map((feat) => (
                      <div key={feat} className="flex items-start gap-2.5 text-xs font-body-sm text-[#404945] group/item">
